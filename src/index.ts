...
class SvgChunkWebpackPlugin {
	...
	/**
	 * Injects the sprite map related to the entry in the related html generated by html-webpack-plugin
	 * @param {Compilation} compilation Webpack compilation
	...
	/**
	 * Get HtmlWebpackPlugin instance from webpack compiler data
	 * @param {Compilation} compilation Webpack compilation
	 * @returns HtmlWebpackPlugin constructor or null
	 */
	...
	/**
	 * Inject sprite HTML into HtmlWebpackPlugin templates
	 * @param {Compilation} compilation Webpack compilation
	 * @param {Sprite[]} options.sprites Sprites
	 * @param data HtmlWebpackPlugin data
