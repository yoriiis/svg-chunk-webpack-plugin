...
```ts
type injectSpritesInTemplates = boolean | { position: "before" | "after", entries: string[]}
```

Default: `false`

Allows the plugin to inject the sprites into the HTML files generated by [html-webpack-plugin](https://github.com/jantimon/html-webpack-plugin).
You can enable it either by passing the value

* `true` : in that case it will inject the sprites at the beginning of the body content on all html files generated by the html-webpack-plugin
* an object with the following properties

#### `injectSpritesInTemplates.position`
...
Specify the location in the html document where the plugin will inject the generated svg sprites, either at the beginning of the body either at the end

#### `injectSpritesInTemplates.entries`
...
Specify the list of entries in which the plugin will operate sprites injection
